...
public class DatabaseInitializer {
    ...
    public void init() {
        ...
        List<String> images = List.of("/api/v1/images/posts/c1790fac-ba51-4784-8085-69b0e2409af7_GTA-VI_Image.jpeg",
                "/api/v1/images/posts/19be26d2-3025-4a49-b61e-3c1ec44e8b73_GTA-VI_Map.webp");
        ...
        Post post1 = new Post("GTA VI Massive leak",
                ...
                LocalDateTime.of(2026, 2, 20, 18, 43), images, user1, topics.get(0));
        ...
        for (int i = 0; i < 20; i++) {
            ...
            post.setContent("This is a test post to populate the database with sample data. It is only for testing purposes and does not contain any meaningful information.");
